        ...
        <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ url('storage', $product->images[0]) }}' }">
                    <div class="sticky top-16 z-40 overflow-hidden ">
                        ...
                        <div class="flex flex-wrap -mx-2">
                            @foreach ($product->images as $image)
                                <div class="w-1/2 sm:w-1/4 p-2" x-on:click="mainImage='{{ url('storage', $image) }}'">
                    ...
                    <div class="lg:pl-20">
                        ...
                        <div class="w-32 mb-8 ">
                            ...
                            <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                                <button  wire:click='decreaseQty({{ $product->id }})' @disabled($quantity <= 1)
